...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'categories':
        return (
          <div className="animate-fade-in rounded-xl border border-[#1e1e2e] bg-[#12121a] p-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">Category management coming soon.</p>
          </div>
        )
      case 'settings':
        return (
          <div className="animate-fade-in rounded-xl border border-[#1e1e2e] bg-[#12121a] p-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-400">System settings coming soon.</p>
          </div>
        )
    }
  }
